...
const FlightBookings = () => {
  ...
  const operatorBookings = bookings.filter(booking => booking.flightName === localStorage.getItem('username'));
  ...
  if (!userDetails) {
    return (
      <div className="flight-bookings-page">
        ...
        <style>{flightBookingsStyles}</style>
      </div>
    );
  }
    ...
    return (
      <div className="flight-bookings-page">
        <div className="status-message pending">
          ...
          <p>Your application is under review. You'll be able to view bookings once approved.</p>
    ...
    <div className="flight-bookings-page">
      <div className="page-header">
        <div className="header-content">
          ...
          <p>Manage bookings for your flights</p>
        </div>
        <div className="header-stats">
          <div className="stat-item">
            <span className="stat-value">{operatorBookings.length}</span>
            <span className="stat-label">Total Bookings</span>
          </div>
          <div className="stat-item">
            <span className="stat-value">{operatorBookings.filter(b => b.bookingStatus === 'confirmed').length}</span>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>No one has booked your flights yet</p>
        </div>
      ) : (
